...
parser.add_argument('--patch_size', type=int, default=8)                        #4)
...
parser.add_argument('--max_iterations', type=int, default= 1000)    #80000)
parser.add_argument('--display_interval', type=int, default=100)
parser.add_argument('--test_interval', type=int, default=5000)
parser.add_argument('--snapshot_interval', type=int, default=100)          #5000)
